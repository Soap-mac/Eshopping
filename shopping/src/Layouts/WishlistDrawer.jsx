...
function WishlistDrawer() {
    ...
    const handleMoveToCart = (product) => addToCart?.(product);
    const handleRemoveItem = (productId) => removeFromWishlist?.(productId);
...
function WishlistItemRow({ product, onMoveToCart, onRemove }) {
    return (
