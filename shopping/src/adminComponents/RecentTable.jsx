...
function RecentTable() {
    ...
    const fetchOrders = async (pageNumber = page) => {
        try {
            ...
            const res = await fetch(
                `${API}/getAllOrders?page=${pageNumber}&limit=10`,
                {
                    method: 'GET',
                    credentials: 'include',
                }
    ...
    return (
        <div className="">
            <h3 className='text-orange-500 text-[25px] !py-[20px] !px-[30px]'>
                RECENT ORDERS
            </h3>
                        ...
                        <tbody>
                            ...
                            {!loading && orders.map((order, index) => (
                                ...
                                >
                                    ...
                                    <th
                                        scope="row"
                                        className="!px-6 !py-4 font-medium text-amber-400 whitespace-nowrap"
                                    >
                                        {order.id}
                                    </th>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 !px-6 !py-4 border-t border-gray-700/50">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                disabled={page === 1}
                                className="!px-3 !py-2 rounded-md border border-gray-700 text-gray-300 hover:bg-gray-800 disabled:opacity-40 disabled:cursor-not-allowed"
                            >
                                Previous
                            </button>
