                                                        ...
                                                        >
                                                            <td className="!px-6 !py-8">
                                                                <div className="flex justify-center">
                                                                    <div className="w-100 h-50 rounded-xl overflow-hidden bg-gray-700/30 border border-gray-600/30 shadow-lg group-hover:shadow-orange-500/20 transition-all duration-300 group-hover:border-orange-500/30">
                                                                        <img
                                                                            src={item.image}
                                                                            alt={item.name}
