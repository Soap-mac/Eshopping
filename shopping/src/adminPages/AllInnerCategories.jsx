...
function AllInnerCategories() {
    const [searchTerm, setSearchTerm] = useState('');

    const [allInnerCategories, setAllInnerCategories] = useState([]);
    const [status, setStatus] = useState(false);

    useEffect(() => {
        const innerCats = async () => {
            try {
                ...
                console.log(result);
                if (result.success) {
                    if (result.innercategories.length > 0) {
                        console.log(result.innercategories);
                        console.log(result.innercategories[0].name);
                        setAllInnerCategories(result.innercategories);
                    }
                }
                                        ...
                                        <tbody>
                                            {filteredCategories.map((item, index) => (
                                                ...
                                                >
                                                    ...
                                                    <td scope="row" className="!px-8 !py-8 font-semibold text-amber-400 whitespace-nowrap">
                                                        <div className="flex items-center gap-3">
                                                    ...
                                                    <td className="!px-6 !py-8">
                                                        <div className="flex items-center justify-center gap-3">
                                                            ...
                                                            <Tooltip title="Delete Category" placement="top">
                                                                ...
                                                                <button onClick={() => handleDelete(item._id)} className="flex items-center justify-center !p-3 rounded-xl bg-red-600/20 hover:bg-red-600/40 border border-red-500/30 hover:border-red-400/50 text-red-400 hover:text-red-300 transition-all duration-300 hover:scale-110 shadow-md hover:shadow-red-500/20 group/btn">
...
export default AllInnerCategories