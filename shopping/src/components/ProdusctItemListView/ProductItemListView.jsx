...
function productitemListView() {
    ...
    return (
        <div className="productItem rounded-[15px] !w-[100%] bg-[#302f2f] flex flex-col sm:flex-row items-center sm:items-start justify-start">
            <div className="imgrapper h-[220px] sm:h-[250px] overflow-hidden rounded-md relative group w-full sm:w-[20%] flex-shrink-0">
                <img src="https://api.spicezgold.com/download/file_1734529297930_fiorra-women-s-teapot-blue-pure-cotton-a-line-kurta-with-sharara-and-dupatta-product-images-rvo9n8udfg-1-202307260626.jpg" alt="" className='w-[89%] mx-auto object-cover rounded-xl shadow-md transition-transform duration-300 hover:scale-105 hover:cursor-pointer' />
                <span className='discount absolute bg-amber-600 top-[10px] left-[10px] !p-1 text-[13px] rounded-md'>10%</span>
                <div className="actions absolute top-[-300px] right-[25px] flex items-center gap-2 flex-col w-[50px] transition-all duration-400 group-hover:top-[15px] max-lg:!top-[15px]">
            ...
            <div className="info !p-3 w-full sm:w-[80%]">
                ...
                <Button className='!w-full sm:!w-[160px] !bg-amber-600 !text-white !mt-[15px] hover:!bg-[#171717]'>Add To Cart</Button>
            </div>
        </div>
    )
}
